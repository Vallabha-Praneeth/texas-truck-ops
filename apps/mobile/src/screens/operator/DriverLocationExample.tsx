...
/**
 * Example-only screen that shows how mobile driver clients can
 * read and update `/drivers/me/location`.
 */
export const DriverLocationExample = () => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <Text style={styles.title}>Driver Location API Example</Text>

        <View style={styles.card}>
          <Text style={styles.sectionTitle}>Current Location State</Text>
          {isLoading ? (
