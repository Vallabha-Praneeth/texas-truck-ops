...
CREATE INDEX IF NOT EXISTS "driver_presence_online_seen_idx" ON "driver_presence" ("is_online","last_seen_at");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "driver_presence_booking_idx" ON "driver_presence" ("booking_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "driver_presence_lat_lng_idx" ON "driver_presence" ("latitude","longitude");
--> statement-breakpoint
DO $$ BEGIN
